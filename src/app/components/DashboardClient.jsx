      ...
      <div className="flex w-full justify-between items-center py-6 px-4 rounded-[8px] border border-[#CFD8DE] bg-white">
        <div className="flex items-center gap-5">
          <div className="relative w-[72px] h-[72px] lg:w-[84px] lg:h-[84px]">
            ...
            <div className="w-full h-full rounded-full overflow-hidden bg-slate-100 border-[3px] border-transparent flex items-center justify-center relative group">
              <img 
                src="/sidebar_profile.png" 
                alt="Profile" 
                className="w-full h-full object-cover" 
              />
              <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity duration-200 flex flex-col items-center justify-center text-white cursor-pointer select-none">
                ...
                <span className="text-[9px] lg:text-[10px] font-bold leading-tight text-center">
                  Change<br />photo
                </span>
              </div>
            </div>
